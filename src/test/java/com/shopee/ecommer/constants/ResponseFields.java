...
public class ResponseFields {
    ...
    static FieldDescriptor fromBirthday = fieldWithPath(AccountRequestDto.Fields.fromBirthday).description("fromBirthday");
    static FieldDescriptor toBirthday = fieldWithPath(AccountRequestDto.Fields.toBirthday).description("toBirthday");
    static FieldDescriptor createFromDate = fieldWithPath(AccountRequestDto.Fields.createFromDate).description("createFromDate");
    static FieldDescriptor createToDate = fieldWithPath(AccountRequestDto.Fields.createToDate).description("createToDate");
    static FieldDescriptor roleAccountList = fieldWithPath(AccountRequestDto.Fields.roleAccountList).description("roleAccountList");
    public static final FieldDescriptor[] requestFieldCreateAccount = {
            id, username, birthday, gender, email, avatar, isActive, mfaEnabled, mfaRegistered, created, updated,
            userCreated.ignored(), userUpdated.ignored(), page.ignored(), size.ignored(), totalRecord.ignored(),
            fromBirthday.ignored(), toBirthday.ignored(), createFromDate.ignored(), createToDate.ignored(),
            roleAccountList.ignored()
    };
